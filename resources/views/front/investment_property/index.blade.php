                ...
                <nav class="pt-4 pb-5 single-apartment-nav">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            @if($prev) <a href="{{ route('front.developro.investment.property', [$prev, Str::slug($prev->name), $floor->number, number2RoomsName($prev->rooms, true), round(floatval($prev->area), 2).'-m2']) }}" class="single-apartment-nav-link-prev">{{ $prev->name }}</a>@endif
                        </div>
                        <div class="col-6 d-flex align-items-center justify-content-end">
                            @if($next) <a href="{{ route('front.developro.investment.property', [$next, Str::slug($next->name), $floor->number, number2RoomsName($next->rooms, true), round(floatval($next->area), 2).'-m2']) }}" class="single-apartment-nav-link-next">{{ $next->name }}</a>@endif
                        </div>
                    </div>
                </nav>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="desc-anim">
                            ...
                            <div class="">
                                <a href="#formularz-kontaktowy" class="project-btn">Zapytaj o ofertę</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row pt-5 pt-sm-0">
                    <div class="col-12 text-center pt-5">
                        <a href="{{ route('front.developro.investment.floor', [$property->floor, Str::slug($property->floor->name)]) }}" class="project-link">Sprawdź więcej</a>
                    </div>
                </div>
            </div>
        </section>
